...
data class WelcomeEmail (
    ...
    override val type = EmailType.WELCOME
...
data class PasswordResetEmail(
    ...
    override val type = EmailType.PASSWORD_RESET
    override fun buildContent(appUrl: String) = EmailContent (
...
data class EmailVerificationEmail(
    ...
    override val type = EmailType.EMAIL_VERIFICATION
    override fun buildContent(appUrl: String) = EmailContent (
...
data class PasswordChangedEmail(
    ...
    override val type = EmailType.PASSWORD_CHANGED
    override fun buildContent(appUrl: String) = EmailContent (
...
data class AccountDeletedEmail(
    ...
    override val type = EmailType.ACCOUNT_DELETED
    override fun buildContent(appUrl: String) = EmailContent (
