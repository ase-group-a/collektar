...
data class ImageCacheConfig (
    ...
    // Sets the TTL of elements saved in the cache
    val cacheTTL: Long,
    ...
    companion object {
        fun fromEnv(env: ApplicationEnvironment): ImageCacheConfig {
            return ImageCacheConfig(
                ...
                cacheTTL= getConfigValueLong(env, "IMAGE_CACHE_TTL", "imageCache.cacheTTL", 60), // Discard after 60 seconds, this should only be used for testing
